...
workflow ASSEMBLE {
    ...
    main:
        ...
        if (params.assembly_qc.enabled || params.binning.enabled) {
            ...
            mapped_reads = mapped_reads | collect(flat: false)
            maps_all = COLLATE_MAPS(mapped_reads, "${params.runId}_reads_to_contigs", "assembly collate-alignments", "--i-alignments", "--o-collated-alignments", true)
