...
workflow ANNOTATE_EGGNOG_MAGS {
    ...
    main:
        ...
        collated_orthologs = COLLATE_HITS_MAGS(SEARCH_ORTHOLOGS_MAGS.out.hits | map { _id, _key -> _key } | collect, "eggnog_orthologs_mags", "types collate-orthologs", "--i-orthologs", "--o-collated-orthologs", true)
        collated_annotations = COLLATE_ANNOTATIONS_MAGS(ANNOTATE_MAGS.out.annotations | map { _id, _key -> _key } | collect, "eggnog_annotations_mags", "types collate-ortholog-annotations", "--i-ortholog-annotations", "--o-collated-annotations", true)
...
workflow ANNOTATE_EGGNOG_MAGS_DEREP {
    ...
    main:
        mags_derep = mags_derep.map { partition ->
            ...
            tuple(filename.substring("mags_derep_partitioned_".length()), partition)
        }
        ...
        collated_orthologs = COLLATE_HITS_MAGS_DEREP(SEARCH_ORTHOLOGS_MAGS_DEREP.out.hits | map { _id, _key -> _key } | collect, "eggnog_orthologs_mags_derep", "types collate-orthologs", "--i-orthologs", "--o-collated-orthologs", true)
        annotations = COLLATE_ANNOTATIONS_MAGS_DEREP(ANNOTATE_MAGS_DEREP.out.annotations | map { _id, _key -> _key } | collect, "eggnog_annotations_mags_derep", "types collate-ortholog-annotations", "--i-ortholog-annotations", "--o-collated-annotations", true)
...
workflow ANNOTATE_EGGNOG_CONTIGS {
    ...
    main:
        ...
        collated_orthologs = COLLATE_HITS_CONTIGS(SEARCH_ORTHOLOGS_CONTIGS.out.hits | map { _id, _key -> _key } | collect, "eggnog_orthologs_contigs", "types collate-orthologs", "--i-orthologs", "--o-collated-orthologs", true)
        collated_annotations = COLLATE_ANNOTATIONS_CONTIGS(ANNOTATE_CONTIGS.out.annotations | map { _id, _key -> _key } | collect, "eggnog_annotations_contigs", "types collate-ortholog-annotations", "--i-ortholog-annotations", "--o-collated-annotations", true)
